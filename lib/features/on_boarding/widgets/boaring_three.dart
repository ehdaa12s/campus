...
class BoaringThree extends StatefulWidget {
  const BoaringThree({super.key});

  @override
  State<BoaringThree> createState() => _BoaringThreeState();
}

class _BoaringThreeState extends State<BoaringThree> {
          ...
          child:Padding(
            ...
            children: [
              ...
              const CustomSizedbox(
                  text: 'لماذا تختار Campus؟',
                  fontSize: 20,
                  color: Color(0xFF101828),
                  fontWight: FontWeight.w700),
              const CustomSizedbox(
                text:
                    'جلسات إرشاد مهني , أدوات إدارة سهلة ومتكاملة , متابعة تقدمك وتحقيق أهدافك المهنية',
                fontSize: 16,
